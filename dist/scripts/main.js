...
// var person = new Person("Jake Smith");     IF THE PARAMETER WAS fullName, IS THIS CREATING AN OBJECT WITH JUST ONE PROPERTY?


function Human (propsObject) {
  if (!propsObject) {
    propsObject = {};
  }
    this.cool = (propsObject.cool === undefined) ? false : propsObject.cool;
};
